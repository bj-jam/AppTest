 ...
 * 饼图
 */
public class ColorCirclePieView extends View {
    ...
    public ColorCirclePieView(Context context) {
        super(context);
        init();
    }

    public ColorCirclePieView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (radius == 0) {
            ...
            // 左边画图起点
            radiusX = (w - radius * 2) / 2;
            // 顶部画图起点
            radiusY = (h - radius * 2) / 2;
    ...
    private void drawPie(Canvas canvas) {
        ...
        // 画占比图
        circleRectF.set(radiusX + 5, radiusY + 5, 2 * radius + radiusX - 5, 2
                * radius + radiusY - 5);
