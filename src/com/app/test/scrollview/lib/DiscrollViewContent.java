package com.app.test.scrollview.lib;
...
public class DiscrollViewContent extends LinearLayout {
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attrs) {
            super(context, attrs);
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ScrollViewLayoutParams);
            try {
                mDiscrollveAlpha = a.getBoolean(R.styleable.ScrollViewLayoutParams_discrollve_alpha, false);
                mDiscrollveScaleX = a.getBoolean(R.styleable.ScrollViewLayoutParams_discrollve_scaleX, false);
                mDiscrollveScaleY = a.getBoolean(R.styleable.ScrollViewLayoutParams_discrollve_scaleY, false);
                mDiscrollveTranslation = a.getInt(R.styleable.ScrollViewLayoutParams_discrollve_translation, -1);
                mDiscrollveThreshold = a.getFloat(R.styleable.ScrollViewLayoutParams_discrollve_threshold, 0.0f);
                mDiscrollveFromBgColor = a.getColor(R.styleable.ScrollViewLayoutParams_discrollve_fromBgColor, -1);
                mDiscrollveToBgColor = a.getColor(R.styleable.ScrollViewLayoutParams_discrollve_toBgColor, -1);
            } finally {
                a.recycle();
            }
        }
