...
class TeachTalkTogetherView : RelativeLayout {
    private val dp10: Int by lazy { DensityUtil.dp2px(10) }
    private val dp15: Int by lazy { DensityUtil.dp2px(15) }
    private val dp20: Int by lazy { DensityUtil.dp2px(20) }
    private val dp65: Int by lazy { DensityUtil.dp2px(65) }
    ...
    init {
        ...
        layoutParams = layoutParams?.also { it.width = dp65 }
                ?: LayoutParams(dp65, LayoutParams.WRAP_CONTENT)
        ...
        val initRoundImg: (roundImg: RoundedImageView, order: Int) -> Unit = { it, order ->
            ...
            //todo
            if (order == 5) {
                it.setImageResource(R.color.white)
            } else {
                it.setImageResource(picArr[order - 1])
            }
