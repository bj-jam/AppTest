...
public class MagicTextView extends AppCompatTextView {
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            if (a.hasValue(R.styleable.MagicTextView_ui_strokeColor)) {
                float strokeWidth = a.getFloat(R.styleable.MagicTextView_ui_strokeWidth, 1);
                int strokeColor = a.getColor(R.styleable.MagicTextView_ui_strokeColor, 0xff000000);
                float strokeMiter = a.getFloat(R.styleable.MagicTextView_ui_strokeMiter, 10);
                Join strokeJoin = null;
                switch (a.getInt(R.styleable.MagicTextView_ui_strokeJoinStyle, 0)) {
                    case (0):
