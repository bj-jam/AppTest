 ...
 *
 */
public class HeaderScrollView extends ListView {

    private ImageView mImageView;
    private int initHeight;//初始高度
    ...
    public HeaderScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initHeight = context.getResources().getDimensionPixelOffset(R.dimen.size_default_height);
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_UP) {
            ResetAnimation resetAnimation = new ResetAnimation(initHeight);
            //设置动画的迭代器 有波动的迭代器
