...
import com.app.ui.material.listener.OnDragVHListener;
import com.app.ui.material.listener.OnItemMoveListener;
import com.app.ui.material.util.Logger;
...
public class DragRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    // 我的频道 标题部分
    ...
    private List<TagBean> mMyChannelItems;
    private List<TagBean> mOtherChannelItems;
    // 我的频道点击事件
    private OnMyChannelItemClickListener mChannelItemClickListener;
    private OnCompleteListener mCompleteListener;
    private int selectedType;

    public DragRecyclerViewAdapter(Context context, ItemTouchHelper helper, List<TagBean> mMyChannelItems,
