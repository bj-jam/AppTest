 ...
 */
package com.app.ui.material.anim;
...
public class CustomItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0)
                .translationX(-holder.itemView.getWidth()).setListener(
     ...
     * then CustomItemAnimator will call {@link #animateMove(ViewHolder, int, int, int, int)} and
