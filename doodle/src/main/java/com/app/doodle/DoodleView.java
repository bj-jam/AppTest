...
import com.app.doodle.util.ImageUtils;
import com.app.doodle.util.Util;
import com.app.doodle.core.IDoodle;
import com.app.doodle.core.IDoodleColor;
import com.app.doodle.core.IDoodleItem;
import com.app.doodle.core.IDoodlePen;
import com.app.doodle.core.IDoodleShape;
import com.app.doodle.core.IDoodleTouchDetector;

import static com.app.doodle.util.DrawUtil.drawCircle;
import static com.app.doodle.util.DrawUtil.drawRect;
import static com.app.doodle.util.DrawUtil.rotatePoint;
...
public class DoodleView extends FrameLayout implements IDoodle {
    ...
    public DoodleView(Context context, Bitmap bitmap, boolean optimizeDrawing, IDoodleListener listener, IDoodleTouchDetector defaultDetector) {
        ...
        if (mBitmap.getConfig() != Bitmap.Config.RGB_565) {
            ...
            Log.w(TAG, "the bitmap may contain alpha, which will cause eraser don't work well.");
        }
...
//        transformedEvent.offsetLocation(offsetX, offsetY);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (hasFlag(FLAG_RESET_BACKGROUND)) {
            Log.d(TAG, "FLAG_RESET_BACKGROUND");
            ...
            Log.d(TAG, "FLAG_DRAW_PENDINGS_TO_BACKGROUND");
            clearFlag(FLAG_DRAW_PENDINGS_TO_BACKGROUND);
            clearFlag(FLAG_REFRESH_BACKGROUND);
            ...
            Log.d(TAG, "FLAG_REFRESH_BACKGROUND");
            clearFlag(FLAG_REFRESH_BACKGROUND);
            mBackgroundView.invalidate();
        }
