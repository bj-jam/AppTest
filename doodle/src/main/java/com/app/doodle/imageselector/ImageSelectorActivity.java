package com.app.doodle.imageselector;
...
import com.app.doodle.DoodleActivity;
import com.app.doodle.DoodleParams;
import com.app.doodle.DoodleView;
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    case WHAT_REFRESH_PATH_LIST:
                        if (mAdapter == null) {
                            mAdapter = new ImageSelectorAdapter(ImageSelectorActivity.this, mPathList);
        ...
        if (v.getId() == R.id.btn_back) {
            ...
            if (mAdapter.getSelectedSet().size() > 0) {
                ...
                if (list.size() > 0) {
                    ...
                    // 启动涂鸦页面
                    DoodleActivity.startActivityForResult(this, params, 100);
                }
                finish();
            }
        }
