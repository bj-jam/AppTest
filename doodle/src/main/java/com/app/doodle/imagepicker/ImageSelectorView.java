...
public class ImageSelectorView extends FrameLayout implements View.OnClickListener {
    ...
    public ImageSelectorView(final Context context, boolean isMultipleChoice, int maxCount, final List<String> pathList, ImageSelectorListener listener) {
        super(context);
                ...
                switch (msg.what) {
                    case WHAT_REFRESH_PATH_LIST:
                        if (mAdapter == null) {
                            ...
                            Log.e("jam", "handleMessage: " + mPathList.size());
