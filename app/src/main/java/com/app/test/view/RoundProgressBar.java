...
public class RoundProgressBar extends View {
    ...
    public RoundProgressBar(Context context, AttributeSet attrs) {
        ...
        mTextSize = mTypedArray.getDimension(R.styleable.RoundProgressBar_textSize, getResources().getDimensionPixelSize(R.dimen.dp13));
        textHalfSize = (int) (mTextSize * 0.4f);
        mBorderWidth = mTypedArray.getDimension(R.styleable.RoundProgressBar_borderWidth, getResources().getDimensionPixelSize(R.dimen.dp2));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setStrokeWidth(mBorderWidth - 2); //设置圆环的宽度
