...
public class DampingAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    List<CourseInfo> list;
    Context context;
    RecycleItemClickListener mItemClickListener;

    public DampingAdapter(Context context) {
...
//        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        CourseInfo courseInfo = list.get(position);
