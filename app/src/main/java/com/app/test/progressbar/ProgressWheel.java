...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        textSize = (int) a.getDimension(R.styleable.ProgressWheel_textStringSize, textSize);

        textColor = (int) a.getColor(R.styleable.ProgressWheel_textStringColor, textColor);

        // if the text is empty , so ignore it
        if (a.hasValue(R.styleable.ProgressWheel_textString)) {
            setText(a.getString(R.styleable.ProgressWheel_textString));
        }
