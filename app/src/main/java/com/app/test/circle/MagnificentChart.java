...
// #MARK - Constructors
    ...
    public MagnificentChart(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            boolean isRound = typedArray.getBoolean(R.styleable.MagnificentChart_mc_round, false);
            ...
            int backgroundColor = typedArray.getColor(R.styleable.MagnificentChart_mBackground, Color.parseColor("#FFFFFF"));
